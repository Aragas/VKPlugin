...
namespace VKPlugin.Forms
{
	...
	/// User will be directed to the issues page of project on GitHub
	/// where they can post the generated text.
	/// </summary>
	public partial class GitHubDialog : Form
	{
		private readonly string _author;
		private string Address { get { return "https://github.com/" + _author + "/VKPlugin/issues/new"; } }
		...
		/// <param name="author">Author of this release.</param>
